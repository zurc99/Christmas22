...
const introductionElement = createElementStyle(
  "div",
  `font-size:1.2em;position:absolute;text-align:justify;transition:opacity 2s;width:350px; height:350px`,
  "Clica no botão do lado esquerdo do rato para aumentares a escadinha para o Pai Natal passar de chaminé em chaminé. <br> <br> CUIDADO: Uma escada demasiado grande ou pequena faz o Pai Natal cair!"
